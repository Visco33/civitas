...
COIN_REPO='https://github.com/eastcoastcrypto/Civitas.git'
COIN_TGZ='https://github.com/eastcoastcrypto/Civitas/releases/download/v1.2.2/civitas-1.2.2-i686-pc-linux-gnu.tar.gz'
